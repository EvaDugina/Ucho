...
- **2026-06-10:** `/leta` получила явный статус начала смытия и постепенное растворение Telegram-чата: transport удаляет известные/recent `message_id` по одному с небольшой задержкой, добавляя в очередь удаления подтверждение, стартовый статус и финальное `Смыто.`. Ошибка reset оставляет диагностическое сообщение в чате и не запускает chat purge.
