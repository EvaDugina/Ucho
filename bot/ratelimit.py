...
Контекст: live-запросы идут в OpenRouter. Без ограничителя один гость спамом
вопросов мог бы непрерывно занимать лимиты/слоты модели и блокировать остальных
(в т.ч. владельца). Здесь — два барьера на пользователя:
