"""Prompt-контекст для API-анализа 01."""
...
def relevant_categories(target: dict | None, signals: dict | None) -> tuple[str, ...]:
    ...
    Если активный вопрос уже из 01 или локальные маркеры подсветили категории,
    ставим их первыми; оставшиеся категории тоже даём кратко, чтобы модель могла
    поймать побочный 01-сигнал в ответе на вопрос из другой области.
    """
    ordered: list[str] = []
