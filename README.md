...
4. Связи, реальные противоречия и промоушн `draft → stable` — разбор сильной моделью (скилл `reconcista`); портрет, настроение, психометрика и `personality/softskills.md` — скилл `depersonalization`.
