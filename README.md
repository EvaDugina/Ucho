...
- автоматический вопрос раз в четыре календарных дня и характерная реплика Иуды,
  если предыдущий автоматический вопрос остался без ответа;
...
Автоматический вопрос проверяется ежедневно в `DAILY_HOUR`, но отправляется только
после `DAILY_INTERVAL_DAYS=4` полных календарных дней с прошлого вопроса.
